...
impl Wallet {
    pub fn new(path: PathBuf, id_shared: IdShared, username: &str, password: &str) -> Result<Self> {
        ...
        let raw_wallet = RawWallet::new(username, did);
    ...
    pub fn load(path: PathBuf, id_shared: IdShared, password: &str) -> Result<Self> {
